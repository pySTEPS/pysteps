...
convergence_arg_values = [
    ...
    (reference_field, "farneback", "linear_x", 2, 30),
    (reference_field, "farneback", "linear_y", 2, 30),
    (reference_field, "farneback", "linear_x", 2, 20),
    (reference_field, "farneback", "linear_y", 2, 20),
    (reference_field, "farneback", "linear_x", 2, 15),
    (reference_field, "farneback", "linear_y", 2, 15),
    (reference_field, "farneback", "linear_x", 2, 9),
    (reference_field, "farneback", "linear_y", 2, 9),
    (reference_field, "farneback", "linear_x", 2, 6),
    (reference_field, "farneback", "linear_y", 2, 6),
    (reference_field, "farneback", "linear_x", 2, 4),
    (reference_field, "farneback", "linear_y", 2, 4),
]
