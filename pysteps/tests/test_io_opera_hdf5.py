...
expected_proj1 = ('+proj=laea +lat_0=55.0 +lon_0=10.0 '
                  '+x_0=1950000.0 '
                  '+y_0=-2100000.0 '
                  '+units=m +ellps=WGS84'
                  )
...
test_metadata = [
    ...
    ('ll_lon', -10.434576838640398, 1e-20),
    ('ll_lat', 31.746215319325056, 1e-20),
    ('ur_lon', 57.81196475014995, 1e-20),
    ('ur_lat', 67.62103710275053, 1e-20),
    ('x1', -0.0004161088727414608, 1e-20),
    ('y1', -4400000.001057557, 1e-20),
    ('x2', 3800000.0004256153, 1e-20),
    ('y2', -0.0004262728616595268, 1e-20),
    ('xpixelsize', 2000.0, 1e-20),
    ('xpixelsize', 2000.0, 1e-20),
    ('accutime', 15.0, 1e-20),
    ('yorigin', 'upper', None),
    ('unit', 'mm/h', None),
