...
# TODO: actually you need to add logging handler before pysteps import because
# of the use of logging in the __init__ file.
logging.basicConfig(
...
def main():
    ...
    _LOGGER.debug('Metadata: %s', pformat(metadata))
